...
data class NetworkCallLogModel (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): NetworkCallLogModel {
      ...
      return NetworkCallLogModel(options, request, response)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
interface MADAssistant {
  ...
  fun logCrashReport(throwable: Any, message: String?, data: Map<Any, Any?>?, callback: (Result<Unit>) -> Unit)
  ...
  fun logException(throwable: Any, message: String?, data: Map<String, Any?>?, callback: (Result<Unit>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.logCrashReport(throwableArg, messageArg, dataArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.logException(throwableArg, messageArg, dataArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
