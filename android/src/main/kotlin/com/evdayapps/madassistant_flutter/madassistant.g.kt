...
data class Options (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): Options {
      ...
      return Options(threadName, connectTimeoutMillis, readTimeoutMillis, writeTimeoutMillis, protocol, handshake)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
data class Response (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): Response {
      ...
      return Response(headers, statusCode, timestamp, gzippedLength, length, contentType, body)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
data class ExceptionModel (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): ExceptionModel {
      ...
      return ExceptionModel(exceptionThreadName, crash, type, message, throwableMessage, data, stackTrace, threads)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
data class ExceptionStacktraceLineModel (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): ExceptionStacktraceLineModel {
      ...
      return ExceptionStacktraceLineModel(className, fileName, nativeMethod, methodName, lineNumber)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
interface MADAssistant {
  ...
  fun logCrashReport(exception: ExceptionModel, callback: (Result<Unit>) -> Unit)
  fun logAnalyticsEvent(destination: String, eventName: String, data: Map<Any, Any?>?, callback: (Result<Unit>) -> Unit)
  fun logGenericLog(type: Long, tag: String, message: String, data: Map<Any, Any?>?, callback: (Result<Unit>) -> Unit)
  fun logException(exception: ExceptionModel, callback: (Result<Unit>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: MADAssistant?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.init", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.connect", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.disconnect", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.getConnectionState", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.startSession", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.endSession", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.hasActiveSession", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logCrashes", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logNetworkCall", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logCrashReport", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val exceptionArg = args[0] as ExceptionModel
            api.logCrashReport(exceptionArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logAnalyticsEvent", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            ...
            api.logAnalyticsEvent(destinationArg, eventNameArg, dataArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logGenericLog", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            ...
            api.logGenericLog(typeArg, tagArg, messageArg, dataArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistant.logException", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val exceptionArg = args[0] as ExceptionModel
            api.logException(exceptionArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
...
class MADAssistantCallback(private val binaryMessenger: BinaryMessenger) {
  ...
  fun onSessionStarted(sessionIdArg: Long, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.onSessionStarted", codec)
    channel.send(listOf(sessionIdArg)) {
      callback()
    }
  }
  fun onSessionEnded(sessionIdArg: Long, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.onSessionEnded", codec)
    channel.send(listOf(sessionIdArg)) {
      callback()
    }
  }
  fun onConnectionStateChanged(stateArg: ConnectionManagerState, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.onConnectionStateChanged", codec)
    channel.send(listOf(stateArg.raw)) {
      callback()
    }
  }
  fun onDisconnected(codeArg: Long, messageArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.onDisconnected", codec)
    channel.send(listOf(codeArg, messageArg)) {
      callback()
    }
  }
  fun logInfo(tagArg: String, messageArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.logInfo", codec)
    channel.send(listOf(tagArg, messageArg)) {
      callback()
    }
  }
  fun logVerbose(tagArg: String, messageArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.logVerbose", codec)
    channel.send(listOf(tagArg, messageArg)) {
      callback()
    }
  }
  fun logDebug(tagArg: String, messageArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.logDebug", codec)
    channel.send(listOf(tagArg, messageArg)) {
      callback()
    }
  }
  fun logWarn(tagArg: String, messageArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.logWarn", codec)
    channel.send(listOf(tagArg, messageArg)) {
      callback()
    }
  }
  fun logError(errorArg: ExceptionModel, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.madassistant.MADAssistantCallback.logError", codec)
